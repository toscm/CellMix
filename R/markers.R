...
setAnnotation <- function(object, value){
    ...
    # set annotation
    if( hasMethod('annotation<-', class(object)) ) annotation(object) <- value
    else attr(object, 'annotation') <- value
...
#' 
#' @aliases [,MarkerList,ANY,ANY,ANY-method
#' @rdname subset
#' @export
#' @examples
#' 
...
#' 
#' @aliases [,MarkerList,list,ANY,ANY-method
#' @rdname subset
#' @export
...
#'
#' @aliases [,MarkerList,missing,list,ANY-method
#' @rdname subset
#' @export
